        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-cream border border-warm-subtle rounded-2xl px-5 py-4 flex items-center justify-between gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <span
                className={`inline-flex items-center gap-1.5 text-[0.75rem] font-medium px-2.5 py-0.5 rounded-full border self-start ${doctorStatusConfig[currentStatus].classes}`}
              >
                <span
                  className={`w-1.5 h-1.5 rounded-full ${doctorStatusConfig[currentStatus].dot}`}
                />
            ...
            <div className="flex items-center gap-2 flex-wrap justify-end">
              {(
                Object.keys(doctorStatusConfig) as NonNullable<
                  Doctor["status"]
                >[]
              ).map(
                (s) =>
              ...
              {showArchived &&
                archived.map((a) => (
                  ...
                  >
                    ...
                    <span
                      className={`text-[0.6875rem] font-medium px-2.5 py-0.5 rounded-full shrink-0 ${statusConfig[a.status].classes}`}
                    >
                      {statusConfig[a.status].label}
                    </span>
                  </div>
