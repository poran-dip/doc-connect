          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div className="flex flex-col gap-1">
                ...
                <span className="text-[0.75rem] text-warm-muted font-light">
                  {new Date(a.appointmentTime).toLocaleDateString(undefined, {
                    weekday: "short",
                    month: "short",
                    day: "numeric",
                  })}
                ...
                {a.assignedDoctor ? (
                  ...
                  <span className="text-[0.75rem] text-warm-muted/40 font-light italic">
                    No doctor assigned
                  </span>
                )}
              </div>
            ...
            {a.status !== "completed" &&
              ...
              availableDoctors.length > 0 && (
                <Form
                  method="post"
                  className="flex items-center gap-2 pt-3 border-t border-warm-subtle"
                >
