...
router.post("/", authenticate, authorize("Patient"), async (req: Request, res: Response) => {
...
router.get("/", authenticate, async (req: Request, res: Response) => {
  ...
  const filter = { ...(patientId ? { patientId } : {}), ...(assignedDoctor ? { assignedDoctor } : {}) };
...
router.put("/:id", authenticate, authorize("Admin", "Doctor"), async (req: Request, res: Response) => {
